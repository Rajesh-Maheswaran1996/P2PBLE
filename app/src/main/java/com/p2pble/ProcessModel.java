...
public abstract class ProcessModel {
    ...
    public Matrix state_estimate = new Matrix(stateDimension(), 2);
    ...
    public Matrix predicted_state_midpoint = new Matrix(stateDimension(), 2);
    public Matrix state_delta_scratch = new Matrix(stateDimension(), 2);
